...
struct Strings {
    ...
    struct AppText {
        struct PhoneInputView {
            ...
            static let textPolicy = "Bằng việc chọn tiếp tục, bạn đã đồng ý với https://www.hackingwithswift.com/articles/216/complete-guide-to-navigationview-in-swiftui của CoCo"
